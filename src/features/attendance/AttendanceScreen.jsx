  ...
  if (player) {
    ...
    return (
      <div style={{ padding: '4px 16px 20px' }}>
        ...
        <MonthlySummaryCard practices={practices} attendance={attendance} matches={matches} rsvp={rsvp} gymChecks={gymChecks} routines={routines} player={player} today={today} />
