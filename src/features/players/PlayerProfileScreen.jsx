      ...
      <div style={{ padding: '16px 16px 0' }}>
        ...
        {(p.phone || p.emergency_contact) && (
          <Card pad={14} style={{ marginBottom: 16 }}>
            <div style={{ fontFamily: 'Barlow Condensed, sans-serif', fontWeight: 700, fontSize: 15, color: CC.ink, textTransform: 'uppercase', letterSpacing: 0.4, marginBottom: 10 }}>Contacto</div>
