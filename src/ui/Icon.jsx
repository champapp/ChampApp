...
export function Icon({ name, size = 22, color = 'currentColor', sw = 2 }) {
  ...
  const paths = {
    ...
    trash: <><path d="M4 7h16" {...p} /><path d="M9 7V5a1 1 0 011-1h4a1 1 0 011 1v2" {...p} /><path d="M6 7l1 13a1 1 0 001 1h8a1 1 0 001-1l1-13" {...p} /><path d="M10 11v6M14 11v6" {...p} /></>,
    chat: <><path d="M4 5h16v11H9l-4 4v-4H4z" {...p} /></>,
    send: <><path d="M4 12l16-8-4.5 16-5-6-6-2z" {...p} /></>,
  };
  return (
