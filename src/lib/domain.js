...
export const ROUTINE_SECTIONS = ['CALENTAMIENTO', 'POTENCIA', 'HIPERTROFIA', 'FÍSICO', 'CONDICIONER', 'FUERZA SUBMÁXIMA', 'FUERZA MÁXIMA', 'FUERZA SUBMÁXIMA REPETIDA', 'EVALUACIÓN'];
